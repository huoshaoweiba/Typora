...
import { QrcodeOutlined, SmileOutlined,GroupOutlined} from '@ant-design/icons';
import { useState } from 'react';
import QRCodePanel from './QRCode';
import EmojiPanel from './Emoji';
import { Trans } from '@/i18n/utils';
import LayoutPanel from './JsonSelect';
...
const APP_LIST = [
  ...
  {
    title: <Trans i18nKey="panel.app.Layout" />,
    key: 'layout',
    icon: <GroupOutlined style={{ fontSize: 30 }} />
  },
];
...
export default function AppPanel () {
  ...
  const renderApp = () => {
    ...
    if (app === 'layout') {
      return <LayoutPanel back={back2List} />
    }
    return null;
  }
